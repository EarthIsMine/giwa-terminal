 ...
 * 타겟 유저는 "쌓기→문턱→차감→배분" 네 단어를 문장으로 읽지 않는다 —
 * 왼쪽에서 오른쪽으로 눈이 흐르는 그림 하나로 만들어야 한다 (절대 규칙 3).
 * 카피는 기존 문안을 줄인 것: 숫자·조건을 새로 만들지 않는다.
 * 2~4단계(문턱·차감·배분)는 아래 구조도가 그림으로 한 번 더 말한다.
 *
 * 용어(2026-07-31): "소각"은 크립토 용어라 유저 노출 카피에선 "차감"으로 쓴다.
 * "문턱"은 일상어이고 아래 구조도(문턱 점수·문턱선)와 짝이라 그대로 둔다.
...
const STEPS: readonly {
  ...
  { label: "문턱", desc: "새 자산 상장마다 필요 점수가 공지됩니다" },
  {
    label: "차감",
